...
public static void Main(string[] args) 
    {
        ...
        LlenarVendedores(cola, 1);
        Gerente gerente = new Gerente();
        agregarObservador(cola, gerente);
    ...
    public static void LlenarAlumnos(Coleccionable coleccionable, int opcion)
    {
        ...
        for (int i = 0; i < 20; i++)
        {
            if (opcion == 1)
            {
                alumno = FabricaDeAlumnos.crearAlumnos(1);
            }

            else if (opcion == 2)
            {
                alumno = FabricaDeAlumnos.crearAlumnos(2);
            }
            else if (alumno == null)
            {
                alumno = FabricaDeAlumnos.crearAlumnos(1);
    ...
    public static void LlenarVendedores(Coleccionable coleccionable, int opcion)
    {
        ...
        for (int i = 0; i < 20; i++)
        {
            if (opcion == 1)
            {
                comparable = FabricaDeVendedores.crearVendedor(1);
            }

            else if (opcion == 2)
            {
                comparable = FabricaDeVendedores.crearVendedor(2);
            }
            coleccionable.Agregar(comparable);
            comparable = null;
        }
    ...
    public static void Informar(Coleccionable coleccionable, int opcion) 
    {
        ...
        Console.WriteLine(coleccionable.Minimo());
        Console.WriteLine(coleccionable.Maximo());
        Comparable comparable = FabricaDeAlumnos.crearAlumnos(2);
